@php
  $isEdit = !empty($banner);
  $imgUrl = $isEdit && !empty($banner->image)
    ? asset($banner->image)
...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 items-center">
    <div class="lg:col-span-2">
      <input id="banner_image" type="file" name="image" accept="image/*" class="hidden">
      <label for="banner_image"
        ...
        <div class="h-full flex flex-col items-center justify-center text-center gap-3">
          ...
          <div class="text-sm font-semibold text-gray-800">Add Banner Image</div>
      ...
      <div class="mt-3 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50">
        <img id="banner_preview" src="{{ $imgUrl }}" class="w-full h-36 object-cover" alt="banner preview">
      </div>
    </div>
