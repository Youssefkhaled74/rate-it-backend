...
@section('content')
  <div class="bg-white border border-gray-100 rounded-[24px] p-6 shadow-soft">
    ...
    <form method="POST" action="{{ route('admin.subscription-plans.store') }}" class="mt-6">
      @csrf
