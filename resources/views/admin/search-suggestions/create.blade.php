...
@section('page_title', __('admin.add_suggestion'))
@section('title', __('admin.add_suggestion'))

@section('content')
  <div class="bg-white border border-gray-100 rounded-[24px] p-6 shadow-soft">
    <div class="flex items-center justify-between">
      <h2 class="text-2xl font-semibold text-gray-900">{{ __('admin.add_suggestion') }}</h2>
    ...
    <form method="POST" action="{{ route('admin.search-suggestions.store') }}" class="mt-6">
      @csrf
