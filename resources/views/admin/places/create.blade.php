...
<div class="max-w-3xl">
  <div class="bg-white rounded-3xl shadow-soft border border-gray-100 overflow-hidden">
    ...
    <div class="px-6 md:px-8 py-6 border-b border-gray-100 bg-gradient-to-br from-white to-gray-50">
      <div class="flex items-center justify-between gap-4">
        <div>
          ...
          <p class="text-sm text-gray-500 mt-1">Create a place with brand and subcategory.</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.places.store') }}" enctype="multipart/form-data" class="px-6 md:px-8 py-6">
      @csrf
      @include('admin.places._form', ['place' => null])
