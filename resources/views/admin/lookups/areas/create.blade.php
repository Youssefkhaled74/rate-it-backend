...
@section('title', __('admin.add_area'))
  ...
  <div class="bg-white rounded-3xl shadow-soft border border-gray-100 overflow-hidden">
    ...
    <div class="px-6 md:px-8 py-6 border-b border-gray-100 bg-gradient-to-br from-white to-gray-50">
      <div class="flex items-center justify-between gap-4">
        <div>
          <h2 class="text-xl font-semibold text-gray-900">{{ __('admin.add_area') }}</h2>
    ...
    <form method="POST" action="{{ route('admin.lookups.areas.store') }}" class="px-6 md:px-8 py-6">
      @csrf
      @include('admin.lookups.areas._form', ['area' => null])
