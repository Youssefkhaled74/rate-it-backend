    ...
    @foreach($branches as $br)
      ...
      <div class="rounded-[26px] bg-white border border-gray-100 shadow-soft overflow-hidden">
        <div class="relative h-28 bg-gradient-to-br from-red-50 to-white">
          ...
          <form method="POST" action="{{ route('admin.branches.toggle', $br) }}" class="absolute top-3 left-3">
            @csrf
            @method('PATCH')
            <button type="submit"
          ...
          <div class="absolute top-3 right-3">
            ...
            <div id="branchmenu-{{ $br->id }}" class="hidden absolute right-0 mt-2 w-44 rounded-2xl bg-white border border-gray-100 shadow-lg overflow-hidden">
