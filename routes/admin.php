...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth:admin_web')->group(function () {
        ...
        Route::get('lookups/genders/template', [\App\Http\Controllers\Admin\GendersController::class, 'downloadTemplate'])->name('lookups.genders.template');
        Route::post('lookups/genders/import', [\App\Http\Controllers\Admin\GendersController::class, 'importExcel'])->name('lookups.genders.import');
        ...
        Route::delete('lookups/genders', [\App\Http\Controllers\Admin\GendersController::class, 'bulkDestroy'])->name('lookups.genders.bulk-destroy');
        ...
        Route::get('lookups/nationalities/template', [\App\Http\Controllers\Admin\NationalitiesController::class, 'downloadTemplate'])->name('lookups.nationalities.template');
        Route::post('lookups/nationalities/import', [\App\Http\Controllers\Admin\NationalitiesController::class, 'importExcel'])->name('lookups.nationalities.import');
        ...
        Route::delete('lookups/nationalities', [\App\Http\Controllers\Admin\NationalitiesController::class, 'bulkDestroy'])->name('lookups.nationalities.bulk-destroy');

        Route::get('lookups/cities', [\App\Http\Controllers\Admin\CitiesController::class, 'index'])->name('lookups.cities.index');
        Route::get('lookups/cities/template', [\App\Http\Controllers\Admin\CitiesController::class, 'downloadTemplate'])->name('lookups.cities.template');
        Route::post('lookups/cities/import', [\App\Http\Controllers\Admin\CitiesController::class, 'importExcel'])->name('lookups.cities.import');
        ...
        Route::delete('lookups/cities', [\App\Http\Controllers\Admin\CitiesController::class, 'bulkDestroy'])->name('lookups.cities.bulk-destroy');

        Route::get('lookups/areas', [\App\Http\Controllers\Admin\AreasController::class, 'index'])->name('lookups.areas.index');
        Route::get('lookups/areas/template', [\App\Http\Controllers\Admin\AreasController::class, 'downloadTemplate'])->name('lookups.areas.template');
        Route::post('lookups/areas/import', [\App\Http\Controllers\Admin\AreasController::class, 'importExcel'])->name('lookups.areas.import');
        ...
        Route::delete('lookups/areas', [\App\Http\Controllers\Admin\AreasController::class, 'bulkDestroy'])->name('lookups.areas.bulk-destroy');
    });
});
